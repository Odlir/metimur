...
<div id="kt_content" class="kt-content kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <!-- BEGIN:: MODAL CONTACTO -->
        <div id="kt_modal_contacto" class="modal fade" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">EMPRESA AMBEV PERU - CONTACTOS</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        </button>
                    </div>
                    <div class="modal-body">
                        <table id="kt_table_contact" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Contacto</th>
                                    <th>Teléfono</th>
