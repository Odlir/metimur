                                        ...
                                        <div class="kt-portlet kt-portlet--mobile">
                                            ...
                                            <div class="kt-portlet__body">
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#kt_tabs_1_2">Unidad Organizativa</a>
                                                    </li>
                                                </ul>
                                                    ...
                                                    <div class="tab-pane active" id="kt_tabs_1_1" role="tabpanel">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-4 form-group-sub">
                                                                <label>Código: *</label>
                                                                <input id="txtCodigo" name="txtCodigo" type="text" class="form-control" value="000001" disabled="disabled">
                                                            </div>
                                                            <div class="col-lg-4 form-group-sub">
                                                                <label>Tipo Documento: *</label>
                                                                <select id="cboTipoDocumento" name="cboTipoDocumento" class="form-control" disabled="disabled">
                                                                    <option value="">SELECCIONAR</option>
                                                                    <option value="1" selected="selected">RUC</option>
                                                            ...
                                                            <div class="col-lg-4 form-group-sub">
                                                                ...
                                                                <input id="txtNumeroDocumento" name="txtNumeroDocumento" type="text" class="form-control" value="20515151515" disabled="disabled">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-4 form-group-sub">
                                                                <label>Razón Social: *</label>
                                                                <input id="txtRazonSocial" name="txtRazonSocial" type="text" class="form-control" value="EMPRESA PRUEBA SAC" disabled="disabled">
                                                            </div>
                                                            <div class="col-lg-4 form-group-sub">
                                                                <label>Razón Comercial:</label>
                                                                <input id="txtRazonComercial" name="txtRazonComercial" type="text" class="form-control" value="EMPRESA PRUEBA SAC" disabled="disabled">
                                                            </div>
                                                            <div class="col-lg-4 form-group-sub">
                                                                <label>Logo:</label>
                                                                <div></div>
                                                                <div class="custom-file">
                                                                    <input id="filLogo" type="file" class="custom-file-input" disabled="disabled">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-4 form-group-sub">
                                                                ...
                                                                <select id="cboIndustria" name="cboIndustria" class="form-control" disabled="disabled">
                                                                    <option value="">SELECCIONAR</option>
                                                                    <option value="1" selected>INDUSTRIA 1</option>
                                                            ...
                                                            <div class="col-lg-4 form-group-sub">
                                                                ...
                                                                <select id="cboNaturaleza" name="cboNaturaleza" class="form-control" disabled="disabled">
                                                                    <option value="">SELECCIONAR</option>
                                                                    <option value="1" selected="selected">ASOCIACIONES</option>
                                                            ...
                                                            <div class="col-lg-4 form-group-sub">
                                                                ...
                                                                <select id="cboVolumen" name="cboVolumen" class="form-control" disabled="disabled">
                                                                    <option value="">SELECCIONAR</option>
                                                                    <option value="1" selected="selected">5-10</option>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-4 form-group-sub">
                                                                ...
                                                                <select id="cboNroEmpleado" name="cboNroEmpleado" class="form-control" disabled="disabled">
                                                                    <option value="">SELECCIONAR</option>
                                                                    <option value="1" selected="selected">5-10</option>
                                                                    <option value="2">11-30</option>
                                                                    <option value="3">31-75</option>
                                                            ...
                                                            <div class="col-lg-4 form-group-sub">
                                                                <label>Estado:</label>
                                                                <select id="cboEstado" name="cboEstado" class="form-control" disabled="disabled">
                                                                    <option value="">SELECCIONAR</option>
                                                                    ...
                                                                    <div class="form-group row align-items-center" data-repeater-item="">
                                                                        <div class="col-md-3">
                                                                            <div class="kt-form__group--inline">
                                                                                ...
                                                                                <div class="kt-form__control"><input type="text" class="form-control" value="James Butt" disabled="disabled"></div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="kt-form__group--inline">
                                                                                ...
                                                                                <div class="kt-form__control"><input type="text" class="form-control" value="621-8927" disabled="disabled"></div>
                                                                            </div>
                                                                            <div class="d-md-none kt-margin-b-10"></div>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <div class="kt-form__group--inline">
                                                                                ...
                                                                                <div class="kt-form__control"><input type="text" class="form-control" value="904-845-1427" disabled="disabled"></div>
                                                                            </div>
                                                                            <div class="d-md-none kt-margin-b-10"></div>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <div class="kt-form__group--inline">
                                                                                ...
                                                                                <div class="kt-form__control"><input type="text" class="form-control" value="jbutt@gmail.com" disabled="disabled"></div>
                                                                            </div>
                                                                            <div class="d-md-none kt-margin-b-10"></div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <form class="kt-form kt-form--fit">
                                                            <div class="row kt-margin-b-20">
                                                                <div class="col-lg-12 kt-align-right">
                                                                    ...
                                                                    <button id="btn-delete-section-detail" class="btn btn-danger btn-icon-sm"><i class="flaticon-delete"></i> <span class="kt-hidden-mobile">Eliminar Registro</span></button>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <table id="kt_table_section" class="table table-striped table-bordered table-hover table-checkable">
                                                                        <thead>
                                                                        <tr>
                                                                            <th>Código</th>
                                                                            <th>Nombre</th>
