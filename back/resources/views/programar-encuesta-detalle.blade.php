...
@section('content')
                                        ...
                                        <div class="kt-portlet kt-portlet--mobile">
                                            ...
                                            <div class="kt-portlet__body">
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#kt_tabs_1_2">Personas</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#kt_tabs_1_3">Evaluaciones</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#kt_tabs_1_4">Preguntas</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#kt_tabs_1_5">Notificaciones</a>
                                                    </li>
                                                </ul>
                                                        ...
                                                        <form class="kt-form kt-form--fit">
                                                            <div class="row kt-margin-b-20">
                                                                <div class="col-lg-12 kt-align-right">
                                                                    <a href="javascript:;" data-toggle="modal" data-target="#kt_modal_asignar" class="btn btn-brand btn-icon-sm"><i class="la la-plus"></i> Asignar</a>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <table id="kt_table_personas" class="table table-striped table-bordered table-hover table-checkable">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>ID</th>
                                                                                <th>Datos</th>
        ...
        <script type="text/javascript" src="{{asset('assets/js/programar-encuestas.js')}}"></script> 
@endsection
