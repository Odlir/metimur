                                            ...
                                            <div class="kt-portlet__body">
                                                <div class="form-group row">
                                                    <div class="col-lg-3 form-group-sub">
                                                        ...
                                                        <select id="cboCategoria" name="cboCategoria" class="form-control kt-select2">
                                                    ...
                                                    <div class="col-lg-3 form-group-sub">
                                                        <label>Versión:</label>
                                                        <input id="txtVersion" name="txtVersion" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-lg-12 form-group-sub">
                                                        ...
                                                        <div class="kt-tinymce">
                                                            <textarea id="txtDescripcion" name="txtDescripcion" class="tox-target">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-4 form-group-sub">
                                                        ...
                                                        <select id="cboTipoEvaluacion" name="cboTipoEvaluacion" class="form-control kt-select2">
                                                            ...
                                                            <option value="2">Evaluación 360</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-lg-4 form-group-sub">
                                                        <label>Alineamiento:</label>
                                                        <select id="cboAlineamiento" name="cboAlineamiento" class="form-control kt-select2">
                                                            <option value="">Seleccionar</option>
