                                                            ...
                                                            <ul class="kt-nav">
                                                                <li class="kt-nav__item">
                                                                    <a href="javascript:;" class="kt-nav__link">
                                                                        <i class="kt-nav__link-icon fa fa-envelope"></i>
                                                                        <span class="kt-nav__link-text">Enviar por Correo</span>
                                                                    </a>
                                                                </li>
                                                                <li class="kt-nav__item">
                                                                    <a href="javascript:;" class="kt-nav__link">
                                            ...
                                            <div class="kt-portlet__body">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-lg-4 form-group-sub">
                                                        ...
                                                        <select id="cboCalculo" name="cboCalculo" class="form-control kt-select2">
                                                            <option value="">SELECCIONAR</option>
                                                            <option value="1">Cuantitativa</option>
                                                            <option value="2">Top Two Box</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <!-- SECCIONES DINAMICAS -->
