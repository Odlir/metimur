                                        ...
                                        <div class="kt-portlet kt-portlet--mobile">
                                            ...
                                            <div class="kt-portlet__body">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-lg-3 form-group-sub">
                                                        <label>Top:</label>
                                                        <input id="txtTop" name="txtTop" type="text" class="form-control">
                                                    </div>
                                                    <div class="col-lg-3 form-group-sub">
                                                        <label>Bottom:</label>
                                                        <input id="txtBottom" name="txtBottom" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <!-- SECCIONES DINAMICAS -->
                                                <div class="row form-group">
