...
@section('encuestas_editar_pregunta')
                                        ...
                                        <div class="kt-portlet kt-portlet--mobile">
                                            ...
                                            <div class="kt-portlet__body">
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-toggle="tab" href="#kt_tabs_1_2">Preguntas</a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="kt_tabs_1_2" role="tabpanel">
                                                            ...
                                                            <div class="kt-section">
                                                                ...
                                                                <div class="form-group row kt-mt-25">
                                                                    <div class="col-lg-5 form-group-sub">
                                                                        <label>Sección:</label>
                                                                        <input id="txtSeccion" name="txtSeccion" type="text" class="form-control" value="ORIENTACIÓN A LAS PERSONAS- LIDERAZGO">
                                                                    </div>
                                                                    <div class="col-lg-5 form-group-sub">
                                                                        <label>Pregunta:</label>
                                                                        <input id="txtPregunta" name="txtPregunta" type="text" class="form-control" value="Se preocupa por las personas.">
                                                                    </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-lg-4 form-group-sub">
                                                                        ...
                                                                        <select id="cboTipo" name="cboTipo" class="form-control kt-select2">
                                                                            <option value="">SELECCIONAR</option>
                                                                            <option value="1" selected="selected">Opción Múltiple</option>
                                                                            <option value="2">Opción Única</option>
                                                                            <option value="3">Selección</option>
                                                                            <option value="4">Texto</option>
                                                                            <option value="5">Texto Múltiple</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-lg-4 form-group-sub">
                                                                        <label>Alineación:</label>
                                                                        <select id="cboAlineacion" name="cboAlineacion" class="form-control kt-select2">
                                                                            <option value="">SELECCIONAR</option>
                                                                    ...
                                                                    <div class="col-lg-4 form-group-sub">
                                                                        <label>Orden:</label>
                                                                        <input id="txtOrden" name="txtOrden" type="text" class="form-control" value="1">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-lg-4 form-group-sub">
                                                                        <label>Agrupar Rol:</label>
                                                                        <select id="cboTipoEvaluacion" name="cboTipoEvaluacion" class="form-control kt-select2">
                                                                            <option value="">Seleccionar</option>
                                                                            <option value="1">Jefe</option>
                                                                            <option value="2">Par</option>
                                                                            <option value="3">Coloraborador</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-lg-4 form-group-sub">
                                                                        <label>Estado:</label>
                                                                        <select id="cboEstado" name="cboEstado" class="form-control kt-select2">
                                                                            <option value="">SELECCIONAR</option>
                                                                            <option value="1" selected="selected">Activo</option>
                                                                            <option value="2">Inactivo</option>
                                                                        </select>
                                                                ...
                                                                <div id="kt_repeater_answer">
                                                                    <div id="kt_repeater_answer" class="form-group form-group-last row">
                                                                        <label class="col-lg-12 col-form-label kt-font-bold">Agregar Respuestas:</label>
                                                                        <div class="col-lg-12" data-repeater-list="">
                                                                            <div class="form-group row align-items-center" data-repeater-item="">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <div class="kt-form__group--inline">
                                                                                        <div class="kt-form__control">
                                                                                            <input type="text" class="form-control" placeholder="Ingresar Valor">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="d-md-none kt-margin-b-10"></div>
                                                                                </div>
                                                                    ...
                                                                    <div class="form-group form-group-last row">
                                                                        <div class="col-lg-12">
                                                                            <a href="javascript:;" data-repeater-create="" class="btn btn-bold btn-sm btn-label-brand">
                                                                                <i class="la la-plus"></i> Agregar Respuesta
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <!-- AUDITORIA -->
                                                        <div id="accordion-audit-question" class="accordion accordion-light accordion-svg-icon kt-margin-t-30-desktop">
                                                            <div class="card">
                                                                <div id="heading-audit" class="card-header">
                                                                    <div class="card-title collapsed" data-toggle="collapse" data-target="#collapse-audit" aria-expanded="false" aria-controls="collapse-audit">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
