                                                        ...
                                                        <form class="kt-form kt-form--fit">
                                                            <div class="row kt-margin-b-20">
                                                                ...
                                                                <div class="col-lg-6 kt-align-right">
                                                                    <a href="programar-encuesta-detalle-cultura.html" class="btn btn-clean kt-margin-r-10">
                                                                        <i class="la la-arrow-left"></i> <span class="kt-hidden-mobile">Regresar a Secciones</span>
                                                                    </a>
                                                                ...
                                                                <div id="kt_repeater_section" class="form-group form-group-last row">
                                                                    ...
                                                                    <div class="col-lg-12" data-repeater-list="">
                                                                        <div class="form-group row align-items-center" data-repeater-item="">
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <div class="kt-form__group--inline">
                                                                                    <div class="kt-form__label"><label>Tipo:</label></div>
                                                                                    <div class="kt-form__control">
                                                                                        <select class="form-control kt">
                                                                                            <option value="">SELECCIONAR</option>
                                                                                            <option value="1" selected>Selección</option>
                                                                                            <option value="2">Texto</option>
                                                                                            <option value="3">Texto Múltiple</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="d-md-none kt-margin-b-10"></div>
                                                                            ...
                                                                            <div class="col-md-2 kt-align-center">
                                                                                <a href="javascript:;" data-toggle="modal" data-target="#kt_modal_importar" class="btn-sm btn btn-label-brand btn-bold">
                                                                                    <i class="la la-upload"></i> Cargar Malla
                                                                                </a>
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                                <div class="kt-form__group--inline">
