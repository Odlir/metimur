...
@section('content')
                        ...
                        <div id="kt_subheader" class="kt-subheader kt-grid__item">
                            <div class="kt-container kt-container--fluid">
                                <div class="kt-subheader__main">
                                    <h3 class="kt-subheader__title">Mantenimiento de Roles</h3>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="kt-portlet__head-toolbar">
                                                    <div class="kt-portlet__head-wrapper">
                                                        <div class="kt-portlet__head-actions">
                                                            <a href="roles" class="btn btn-clean kt-margin-r-10">
                                                    ...
                                                    <div class="kt-section__body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <h3 class="kt-section__title kt-section__title-sm">Permisos del Rol</h3>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">Mantenimientos</label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="kt-checkbox-list">
                                                                    <label class="kt-checkbox"> <input type="checkbox"> Categorías <span></span></label>
                                                                    <label class="kt-checkbox"> <input type="checkbox"> Empresas <span></span></label>
                                                                    <label class="kt-checkbox"> <input type="checkbox"> Encuestas <span></span></label>
                                                                    <label class="kt-checkbox"> <input type="checkbox"> Industrias <span></span></label>
                                                                    <label class="kt-checkbox"> <input type="checkbox"> Naturaleza <span></span></label>
                                                                    <label class="kt-checkbox"> <input type="checkbox"> Personas <span></span></label>
                                                                    <label class="kt-checkbox"> <input type="checkbox"> Roles <span></span></label>
                                                                    <label class="kt-checkbox"> <input type="checkbox"> Tipo de Documento <span></span></label>
                                                                    <label class="kt-checkbox"> <input type="checkbox"> Tipo de Evaluación <span></span></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">Programación</label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="kt-checkbox-list">
                                                                    <label class="kt-checkbox"> <input type="checkbox"> Encuestas <span></span></label>
                                                                </div>
        ...
        <script type="text/javascript" src="{{asset('json/roles.json')}}"></script>
        <script type="text/javascript" src="{{asset('assets/js/roles.js')}}"></script>   
@endsection
