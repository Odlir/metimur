...
var TipoEvaluacion = function () {
            ...
            if (checkbox == '') {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax(
                            {
                                url: 'http://127.0.0.1:8000/api/tipo_evaluacion_borrar',
                                type: 'delete',
                                data: code,
                                dataType: 'json',
                        ...
                        swal.fire('Eliminado!', 'Registro(s) eliminado(s) correctamente.', 'success').then(()=>{
                            //window.location.href='http://127.0.0.1:8000/tipo-evaluacion';
                        });
                    }
                });
            }
    ...
    var busqueda = function (){
        ...
        $('#kt_search').on( 'click', function (event) {
            ...
            $.ajax(
                {
                    url: 'http://127.0.0.1:8000/api/tipo_evaluacion_dt2',
                    type: 'GET',
                    data: code,
                    dataType: 'json',
                    success: function (response)
